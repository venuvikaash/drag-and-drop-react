...
export default function TeamCalendar() {
  ...
  const calendarData = [
    ...
    { day: "Sun", date: 1, events: [
      { id: 1, type: "my-leave", title: "On Leave", users: ["user1", "user2"] }
    ]},
    { day: "Mon", date: 2, events: [] },
    { day: "Tue", date: 3, events: [] },
    { day: "Wed", date: 4, events: [
      { id: 2, type: "event", title: "Meeting with Chris" }
    ]},
    { day: "Thu", date: 5, events: [
      { id: 3, type: "team-leave", title: "Lunch at Mom's" }
    ]},
    { day: "Fri", date: 6, events: [] },
    { day: "Sat", date: 7, events: [] },
    { day: "Sun", date: 8, events: [] },
    { day: "Mon", date: 9, events: [
      { id: 4, type: "event", title: "Financial Advisor Meeting" }
    ]},
    { day: "Tue", date: 10, events: [
      { id: 5, type: "event", title: "Weather on Flights" },
      { id: 6, type: "my-leave", title: "On Leave", users: ["user1", "user3"] }
    ]},
    { day: "Wed", date: 11, events: [] },
    { day: "Thu", date: 12, events: [
      { id: 7, type: "team-leave", title: "Ashley's Chili Raclette" }
    ]},
    ...
    { day: "Wed", date: 25, events: [
      { id: 18, type: "team-leave", title: "Flight to Japan" }
    ]},
    ...
    { day: "Sat", date: 28, events: [
      { id: 22, type: "event", title: "Meeting on May" }
    ]},
    { day: "Sun", date: 29, events: [
      { id: 23, type: "event", title: "Pick up Jerry from the park" },
      { id: 24, type: "event", title: "Basketball contest" }
    ]},
    { day: "Mon", date: 30, events: [
      { id: 25, type: "my-leave", title: "I am covering now" }
    ]},
        ...
        {event.users && event.users.length > 0 && (
          <div className="flex mt-1">
            {event.users.map((user, idx) => (
              <div key={idx} className="bg-gray-300 rounded-full h-5 w-5 flex items-center justify-center -ml-1 first:ml-0 border border-white">
                <User size={12} />
              </div>
            ))}
          </div>
  ...
  return (
    <div className="mx-auto bg-white p-4 rounded-lg shadow !h-[60vh]">
      ...
      <div className="grid grid-cols-7 gap-2">
        ...
        {calendarData.map((day, idx) => (
          <div 
            key={idx} 
            className={`h-28 p-1 ${day.day === null ? 'bg-gray-50 text-gray-400' : 'bg-white'}`}
          >
